...
```{r, echo = F}
# library("magick")
# av_video_images("2-Clean Data/Catfish_20220906.mp4", destdir = tempfile(pattern = "file", tmpdir = "2-Clean Data/Catfish_20220906"), format = "jpg", fps = NULL) 
# 
# av_video_images("2-Clean Data/Catfish_20220918.mp4", destdir = tempfile(pattern = "file", tmpdir = "2-Clean Data/Catfish_20220918"), format = "jpg", fps = NULL) 
# 
# cat_06_pic <- paste0("2-Clean Data/Catfish_20220906/file228c1bcb3c22/", list.files("2-Clean Data/Catfish_20220906/file228c1bcb3c22"))
# cat_18_pic <- paste0("2-Clean Data/Catfish_20220918/file228c371336/", list.files("2-Clean Data/Catfish_20220918/file228c371336"))
# 
# 
# 
# 
# test <- c(image_read(cat_06_pic[1]), image_read(cat_18_pic[1]))
# 
# image_append(image_scale(test, "x300"))
# 
# image_write(image_append(image_scale(test, "x300")), paste0("2-Clean Data/Catfish_stitch/catfish", 1, ".jpg"), format = "jpg")
# 
# # for(i in 1:length(cat_06_pic)){
# #   temp <- c(image_read(cat_06_pic[i]), image_read(cat_18_pic[i]))
# #   image_write(image_append(image_scale(temp, "x300")), paste0("2-Clean Data/Catfish_stitch/catfish", i, ".jpg"), format = "jpg")
# # }
# 
# imgs <- paste0("2-Clean Data/Catfish_stitch/", list.files("2-Clean Data/Catfish_stitch"))
# image_list <- lapply(imgs, image_read)
# image_joined <- image_join(image_list)
# img_animated <- image_animate(image_joined)
# image_write(image = img_animated, path = "cat.gif")
```
