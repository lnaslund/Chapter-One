...
```{r co2 eq table}
all_fluxes_pathways %>% mutate(flux_mean_g_m2_day_co2_eq =  flux_mean_g_day_co2_eq/area,flux_2.5_g_m2_day_co2_eq= flux_2.5_g_day_co2_eq/area, flux_97.5_g_m2_day_co2_eq= flux_97.5_g_day_co2_eq/area)%>% select(site, date, pathway, gas, flux_mean_g_day_co2_eq:flux_97.5_g_m2_day_co2_eq) %>% group_by(site, date) %>% summarize(mean_total_kg_co2_eq_day = sum(flux_mean_g_day_co2_eq)*1e-3, mean_total_kg_co2_eq_m2_day = sum(flux_mean_g_m2_day_co2_eq)*1e-3)
```
