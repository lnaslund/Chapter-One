...
```{r, echo = F}
sampcol1 <- plot_grid(time_co2 + theme(legend.position = "none", axis.title.x = element_blank()), 
          space_co2+ theme(legend.position = "none", axis.title.x = element_blank()), 
          time_ch4 + theme(legend.position = "none", axis.title.x = element_blank()),
          space_ch4 + theme(legend.position = "none", axis.title.x = element_blank()), 
          time_eb + theme(legend.position = "none"),
          space_eb + theme(legend.position = "none"), 
          ncol = 2, labels = "AUTO")
